...
class SidebarDocumentTest extends TestCase
{
    public function testRemoteMarkupIsSanitizedAndWrappedInOpaqueSandboxDocument()
    {
        ...
        $this->assertStringContainsString('href="https://wa.me/31612345678" aria-label="Open WhatsApp" target="_blank" rel="noopener noreferrer"', $result['srcdoc']);
