...
```sh
export RONDO_MODULE_VERSION=v1.0.5
...
```sh
php artisan rondo:integration-update --release=v1.0.5 --sha256=<approved-sha256> --check
php artisan rondo:integration-update --release=v1.0.5 --sha256=<same-sha256> --install
```
