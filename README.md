...
```sh
export RONDO_MODULE_VERSION=v1.0.3
...
```sh
php artisan rondo:integration-update --version=v1.0.3 --sha256=<approved-sha256> --check
php artisan rondo:integration-update --version=v1.0.3 --sha256=<same-sha256> --install
```
